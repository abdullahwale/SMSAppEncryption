...
public class newsmssend extends AppCompatActivity implements View.OnClickListener {
            ...
            case R.id.btnSendSMS:
                ...
                if (phoneNo!=null && phoneNo.trim().length()>0){
                    ...
                    if (message!=null && message.trim().length()>0){
                        ...
                        txtMessage.setError("Please write message");

                }else
                    txtphoneNo.setError("Please write number");
